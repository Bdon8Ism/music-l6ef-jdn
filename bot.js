...
client.on('message', async function(message) {
    ...
    const correct = client.guilds.get('518343423787401217').emojis.get("544163651112927233")
    const nope = client.guilds.get('518343423787401217').emojis.get('544163651112927233')
